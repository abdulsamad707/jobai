                ...
                <div class="pageheader-content text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="../../index-education-v1.html">Home</a></li>
                        ...
                        <div class="row row-cols-1 justify-content-center g-4">
                            <div class="col">
                                <div class="post-item style-2">
                                    <div class="post-inner">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <div class="meta-post">
                                                <ul class="lab-ul">
                                                    <li><a href="#"><i class="icofont-calendar"></i>April
                                                            23,2021</a></li>
                                                    <li><a href="#"><i class="icofont-ui-user"></i>Rajib Raj</a>
                                                    </li>
                                                    <li><a href="#"><i class="icofont-speech-comments"></i>09
                                                            Comments</a></li>
                                                </ul>
                                            </div>
                                            <p>Serenity hasir taken poseson mying entre soung these sweet morngs
                                                sprng whch enoywith whole heart create am alones and feel the charm
                                                of exstenceth spot whch the blissouls like mineing am soo happy my
                                                dearsi frend absoribed the exquste sense enjoy my whole hearts alone
                                                and fee the charm of exstenceths spotsi whch was the blis of soulis
                                                mineing amsoing dear frend soingu absoribed the exqust sense tranqui
                                                existence neglect my talentsr should ncapable ofing is drawng singe
                                                wonderful serenty has taken possesison of my entre soulng these
                                                sweet present moment and yet feel that never was greater artst</p>

                                            <blockquote>
                                                <p>Dynamically recaptiualize distributed technologies is wherease
                                                    turnkey channels and onotonectally provide access to resource
                                                    leveling expertise vias worldwide deliverables uolisticly extend
                                                    aserser are diverse vortals. </p>
                                                <cite><a href="#">...Melissa Hunter</a></cite>
                                            </blockquote>

                                            <p>whole heart create am alones and feel the charm of exstenceth spot
                                                whch the blissouls like mineing am soo happy my dearsi frend
                                                absoribed the exquste sense enjoy my whole hearts alone and fee the
                                                charm of exstenceths spotsi whch was the blis of soulis mineing
                                            ...
                                            <div class="video-thumb">
                                                ...
                                                <a href="https://www.youtube.com/embed/eEzD-Y97ges"
                                                    class="video-button" data-rel="lightcase"><i
                                ...
                                <div class="navigations-part">
                                    <div class="left">
                                        <a href="#" class="prev"><i class="icofont-double-left"></i>Previous
                                            Article</a>
                                        <a href="#" class="title">Evisculate Parallel Processes via Technica Sound
                                            Models Authoritative</a>
                                    </div>
                                    <div class="right">
                                        <a href="#" class="prev">Next Article<i
                                                class="icofont-double-right"></i></a>
                                        <a href="#" class="title">Qvisculate Parallel Processes via Technica Sound
                                            Models Authoritative</a>
                                    </div>
                                </div>
                                ...
                                <div class="authors">
                                    ...
                                    <div class="author-content">
                                        ...
                                        <p>I'm an Afro-Latina digital artist originally from Long Island, NY. I love
                                            to paint design and photo manpulate in Adobe Photoshop while helping
                                            others learn too. Follow me on Instagram or tweet me</p>
                                        <ul class="lab-ul social-icons">
                                            <li>
                ...
                <aside>
                    ...
                    <div class="widget widget-instagram">
                        ...
                        <ul class="widget-wrapper d-flex flex-wrap justify-content-center">
                            <li><a href="assets/images/blog/01.jpg" data-rel="lightcase"><img src="assets/images/blog/01.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/02.jpg" data-rel="lightcase"><img src="assets/images/blog/02.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/03.jpg" data-rel="lightcase"><img src="assets/images/blog/03.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/04.jpg" data-rel="lightcase"><img src="assets/images/blog/04.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/05.jpg" data-rel="lightcase"><img src="assets/images/blog/05.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/06.jpg" data-rel="lightcase"><img src="assets/images/blog/06.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/07.jpg" data-rel="lightcase"><img src="assets/images/blog/07.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/08.jpg" data-rel="lightcase"><img src="assets/images/blog/08.jpg" alt="product"></a></li>
                            <li><a href="assets/images/blog/09.jpg" data-rel="lightcase"><img src="assets/images/blog/09.jpg" alt="product"></a></li>
                        </ul>
                    </div>
