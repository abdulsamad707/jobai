...
<aside id="minileftbar" class="minileftbar">
    <ul class="menu_list">
        <li>
            ...
            <a class="navbar-brand fw-bold" href="index.html">T</a>
        </li>
                ...
                <div class="body">
                    <ul class="messages list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('backend_assets/assets/images/xs/avatar1.jpg')}}" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('backend_assets/assets/images/xs/avatar2.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('backend_assets/assets/images/xs/avatar3.jpg')}}" alt="">
                                    <div class="media-body">
                ...
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            ...
                            <li><img src="{{asset('backend_assets/assets/images/xs/avatar7.jpg')}}" alt="Avatar"></li>
                        </ul>
                    </a>
                </div>
                <div class="body">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small class="text-muted">Team</small></li>
                            <li><img src="{{asset('backend_assets/assets/images/xs/avatar8.jpg')}}" alt="Avatar"></li>
            ...
            <ul class="list">
                <li>
                    <div class="user-info m-b-20">
                        <div class="image">
                            <a href="profile.html"><img src="{{asset('assets/user/'.$user->avatar)}}" alt="User"></a>
                        </div>
                        <div class="detail">
                            <h6>{{$user->name}}</h6>
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Users</span> <span class="badge badge-default float-right">2</span></a>
                    <ul class="ml-menu">
                ...
                <li class="header">Courses Functions</li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Courses</span> <span class="badge badge-warning float-right">2</span></a>
                    <ul class="ml-menu">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Categories</span> <span class="badge badge-warning float-right">2</span></a>
                    <ul class="ml-menu">
                ...
                <li><a href="{{route('edit-profile',['id'=>$user->id])}}" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Edit Profile</span> <span class="badge badge-default float-right">2</span></a>
