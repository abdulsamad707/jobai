                    ...
                    <div class="body">
                        <form action="{{route('update-category',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" id="text" name="name" class="form-control" placeholder="Enter Name" value="{{$data->name}}">
                            </div>
                            <label for="email_address">Featured Image</label>
                            <div class="form-group">
                                <img src="{{asset('assets/category/'.$data->img)}}" class="mb-3 w-25" alt="">
                                <input type="file" id="text" name="img" class="form-control">
                            </div>

                            <label for="email_address">Description</label>
                            <div class="form-group">
                              <textarea name="description" class="form-control" id="ckeditor" cols="30" rows="5">{{$data->description}}</textarea>
                            </div>
