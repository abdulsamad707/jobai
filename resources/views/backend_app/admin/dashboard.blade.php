                        ...
                        <ul class="follow_us list-unstyled">
                            <li class="online">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('backend_assets/assets/images/xs/avatar4.jpg')}}" alt="">
                            ...
                            <li class="online">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('backend_assets/assets/images/xs/avatar5.jpg')}}" alt="">
                                        <div class="media-body">
                            ...
                            <li class="offline">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('backend_assets/assets/images/xs/avatar2.jpg')}}" alt="">
                                        <div class="media-body">
                            ...
                            <li class="offline">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('backend_assets/assets/images/xs/avatar1.jpg')}}" alt="">
                                        <div class="media-body">
                            ...
                            <li class="online">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('backend_assets/assets/images/xs/avatar3.jpg')}}" alt="">
                                        <div class="media-body">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-md-12">
                                <address>
                                    <strong>TEZHLY Inc.</strong> <small class="float-right">13/04/2018</small><br>
